...
namespace Globeport.Client.Net46.CLI.Commands
{
    ...
    {
        [Argument("A portalId - filter classes by portal", true)]
        public string PortalId { get; set; }

        [Argument("The cursor position (JSON array - [Name,ClassId])", true, new[] { "" })]
        ...
        protected async override Task<object> Execute()
        {
            ...
            return await Api.Client.GetClasses(cursor, PortalId, true, Dependencies);
        }
    }
}
