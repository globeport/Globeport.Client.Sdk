...
{
    [Command("Gets a list of notifications")]
    class GetNotifications : Command
    {
        [Argument("The cursor position (NotificationId)", true, new[] { "" })]
        ...
        protected async override Task<object> Execute()
        {
            ...
            return await Api.Client.GetNotifications(cursor, Dependencies);
        }
    }
}
